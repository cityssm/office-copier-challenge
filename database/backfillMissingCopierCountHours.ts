...
export default function backfillMissingCopierCountHours(): number {
  ...
  let previousRow: HourlyMaximumRow | undefined
  ...
  if (backfillRows.length > 0) {
    const insertBackfillStatement = database.prepare(/* sql */ `
      INSERT INTO
